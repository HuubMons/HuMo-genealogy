...
if ($index_list == 'places') {
    ...
    if (isset($_GET['reset'])) {
        ...
        if (isset($_SESSION["save_select_birth"])) {
            $select_birth = $_SESSION["save_select_birth"];
        }
        if (isset($_SESSION["save_select_bapt"])) {
            $select_bapt = $_SESSION["save_select_bapt"];
        }
        if (isset($_SESSION["save_select_place"])) {
            $select_place = $_SESSION["save_select_place"];
        }
        if (isset($_SESSION["save_select_death"])) {
            $select_death = $_SESSION["save_select_death"];
        }
        if (isset($_SESSION["save_select_buried"])) {
            $select_buried = $_SESSION["save_select_buried"];
        }
        if (isset($_SESSION["save_select_event"])) {
            $select_event = $_SESSION["save_select_event"];
        }
    }
}
...
if (
    $selection['pers_firstname'] or $selection['pers_prefix'] or $selection['pers_lastname'] or $selection['birth_place'] or $selection['death_place']
    ...
    if ($selection['pers_lastname']) {
        if ($selection['pers_lastname'] == __('...')) {
            ...
            $query .= $and . " CONCAT( REPLACE(pers_prefix,'_',' ') ,pers_lastname) " .
                name_qry($selection['pers_lastname'], $selection['part_lastname']);
            $and = " AND ";
        } else {
            $query .= $and . " pers_lastname " . name_qry($selection['pers_lastname'], $selection['part_lastname']);
            $and = " AND ";
        }
    }
    ...
    if ($selection['birth_place']) {
        ...
        $query .= $and . "(pers_birth_place " . name_qry($selection['birth_place'], $selection['part_birth_place']);
        $and = " AND ";
        $query .= " OR pers_bapt_place " . name_qry($selection['birth_place'], $selection['part_birth_place']) . ')';
        $and = " AND ";
    }
    ...
    if ($selection['death_place']) {
        ...
        $query .= $and . "(pers_death_place " . name_qry($selection['death_place'], $selection['part_death_place']);
        $and = " AND ";
        $query .= " OR pers_buried_place " . name_qry($selection['death_place'], $selection['part_death_place']) . ')';
        $and = " AND ";
    }
    ...
    if ($selection['own_code']) {
        $query .= $and . "pers_own_code " . name_qry($selection['own_code'], $selection['part_own_code']);
        $and = " AND ";
    }
    ...
    if ($selection['gednr']) {
        ...
        $query .= $and . "pers_gedcomnumber " . name_qry($selection['gednr'], $selection['part_gednr']);
        $and = " AND ";
    }
    ...
    if ($selection['text']) {
        ...
        $query .= $and . " (pers_text " . name_qry($selection['text'], $selection['part_text']) . "
            OR fam_text " . name_qry($selection['text'], $selection['part_text']) . ")";
        $and = " AND ";
