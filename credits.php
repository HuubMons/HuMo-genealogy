...
<div style="direction:ltr;margin-left:10px">
	...
	<ul>
		...
		<li>Yossi Beck (overall support, programmer):
			<ul>
				<li>Outline report, fanchart, graphical descendant chart and ancestor sheet.
	...
	<ul>
		<li>Klaas de Winkel:
			<ul>
				<li>Textual ancestor report
				<li>Textual descendant report
			</ul>
		<li>Jan Maat:
			<ul>
				<li>Secure admin files.
			</ul>
		<li>Jeroen Beemster:
			<ul>
				<li>Aldfaer photo's and text.
		...
		<li>René Janssen:
			<ul>
				<li>Graphical ancestor chart: better lay-out (colours) and pictures
				<li>Statistics for visitors.
			</ul>
		<li>Erwin Maas:
			<ul>
				<li>Help screen for visitors.
				<li>Stylesheet select and multiple stylesheets.
				<li>Latest changes screen.
			</ul>
		<li>Huych Constant:
			<ul>
				<li>Elegant Corsiva theme.
			</ul>
		<li>Tonko Boekhoud:
			<ul>
				<li>Changes to use HuMo-genealogy into CMS Made Simple.
			</ul>
	</ul>
