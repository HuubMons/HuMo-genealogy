...
<form method="post" action="index.php?page=settings&amp;menu_admin=settings_special" class="p-2">
    ...
    <div class="genealogy_search p-2">
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" value="y" name="death_char" <?php if (isset($humo_option['death_char']) and $humo_option['death_char'] == "y") echo 'checked'; ?>>
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="admin_hebdate" <?php if (isset($humo_option['admin_hebdate']) and $humo_option['admin_hebdate'] == "y") echo 'checked'; ?>>
            <label class="form-check-label"><?= __('Display Hebrew date after Gregorian date: 23 Dec 1980 (16 Tevet 5741)'); ?></label>
        </div>

        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="david_stars" <?php if (isset($humo_option['david_stars']) and $humo_option['david_stars'] == "y") echo 'checked'; ?>>
            <label class="form-check-label"><?= __('Place yellow Stars of David before holocaust victims in lists and reports'); ?></label>
        </div>

        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="death_shoa" <?php if (isset($humo_option['death_shoa']) and $humo_option['death_shoa'] == "y") echo 'checked'; ?>>
        ...
        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="admin_hebnight" <?php if (isset($humo_option['admin_hebnight']) and $humo_option['admin_hebnight'] == "y") echo 'checked'; ?>>
            <label class="form-check-label"><?= __('Add "night" checkbox next to Gregorian dates to calculate Hebrew date correctly'); ?></label>
        </div>

        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="admin_hebname" <?php if (isset($humo_option['admin_hebname']) and $humo_option['admin_hebname'] == "y") echo 'checked'; ?>>
            <label class="form-check-label"><?= __('Add field for Hebrew name in name section of editor (instead of in "events" list)'); ?></label>
        </div>

        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="admin_brit" <?php if (isset($humo_option['admin_brit']) and $humo_option['admin_brit'] == "y") echo 'checked'; ?>>
            <label class="form-check-label"><?= __('Add field for Brit Mila under birth fields (instead of in "events" list)'); ?></label>
        </div>

        <div class="form-check">
            <input type="checkbox" class="form-check-input" name="admin_barm" <?php if (isset($humo_option['admin_barm']) and $humo_option['admin_barm'] == "y") echo 'checked'; ?>>
