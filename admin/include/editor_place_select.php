...
// *** Search for place ***
$url_add='';
if (isset($url_form)) $url_add.='&amp;form='.$url_form;
if (isset($url_place_item)) $url_add.='&amp;place_item='.$url_place_item;
if (isset($url_address_id)) $url_add.='&amp;address_id='.$url_address_id;
if (isset($url_event_id)) $url_add.='&amp;event_id='.$url_event_id;
$quicksearch_place=''; if (isset($_POST['search_quicksearch_place'])){
