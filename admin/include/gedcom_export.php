	...
	*/
	...
	while ($persons=$persons_result->fetch(PDO::FETCH_OBJ)){
		...
		if ($person->pers_alive == 'deceased'){
			if (!$person->pers_death_date AND !$person->pers_death_place AND !$person->pers_death_text AND !$person->pers_death_cause
