...
while ($userDb = $user->fetch(PDO::FETCH_OBJ)) {
	...
	if ($userDb->user_name != 'gast' and $userDb->user_name != 'guest' and $userDb->user_id != '1') {
		...
		echo '<img src="/theme/admin/images/button_drop.png" border="0" alt="remove person"></a> ';
	} else
		echo '&nbsp;&nbsp;';
	...
	//echo '<td>';
	//echo '<a href="javascript:;" onClick=window.open("index.php?page=editor_user_settings&user='.$userDb->user_id.'","","scrollbars=1,width=900,height=500,top=100,left=100");><img src="/theme/images/search.png" border="0"></a>';
	$extra_icon = "/theme/images/search.png";
	if ($userDb->user_hide_trees != '' or $userDb->user_edit_trees != '') {
		$extra_icon = "/theme/images/searchicon_red.png";
	}
	echo '<td>';
