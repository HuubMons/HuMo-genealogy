...
class editor_event_cls
{
    ...
    function event_text($event_kind, $event_gedcom = '')
    {
        ...
        if ($event_kind == 'person') {
            ...
            */
            ...
            $qry = "SELECT * FROM humo_events
                ...
                'death_declaration','profession','religion','picture',
                'witness')
                " . $hebtext . "
                ORDER BY event_kind, event_order";
        } elseif ($event_kind == 'name') {
                ...
                <tr <?= $expand_link . $change_bg_colour; ?>>
                    ...
                    <td colspan=" 2">
                        ...
                        ?>
                            ...
                            <!-- Show name of item -->
                            <?= $this->event_text($data_listDb->event_kind, $data_listDb->event_gedcom); ?>:
