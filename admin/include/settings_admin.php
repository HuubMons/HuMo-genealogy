...
if (isset($menu_admin) and $menu_admin == 'settings') {
    ...
    //} else {
        $cols = "80";
    //}   // in joomla make sure it won't run off the screen
    ...
    $selected = '';
    if ($humo_option["debug_front_pages"] != 'y') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["debug_admin_pages"] != 'y') $selected = ' SELECTED';
    echo '<option value="y">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    echo '</select> ';
    printf(__('Only use this option to debug problems in %s.'), 'HuMo-genealogy');
    ...
    $selected = '';
    if ($humo_option["url_rewrite"] != 'j') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["searchengine"] != 'j') $selected = ' SELECTED';
    echo '<option value="j">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    echo "</select><br>";
    //if (CMS_SPECIFIC == "Joomla") {
    ...
    $selected = '';
    if ($humo_option["searchengine_cms_only"] != 'y') $selected = ' SELECTED';
    echo '<option value="y">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    ...
    $selected = '';
    if ($humo_option["use_spam_question"] != 'y') $selected = ' SELECTED';
    echo '<option value="y">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    echo '</select>';
    echo '</td></tr>';
    ...
    $selected = '';
    if ($humo_option["use_newsletter_question"] != 'y') $selected = ' SELECTED';
    echo '<option value="y">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    echo "</select> ";
    ...
    $selected = '';
    if ($humo_option["visitor_registration"] != 'y') $selected = ' SELECTED';
    echo '<option value="y">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    echo '</select> ';
    ...
    $selected = '';
    if ($humo_option["registration_use_spam_question"] != 'y') $selected = ' SELECTED';
    echo '<option value="y">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    echo '</select>';
    echo '</td></tr>';
    ...
    $selected = '';
    if ($humo_option["mail_auto"] == 'auto') $selected = ' SELECTED';
    echo '<option value="auto"' . $selected . '>' . __('auto') . '</option>';
    $selected = '';
    if ($humo_option["mail_auto"] == 'manual') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["smtp_port"] == '25') $selected = ' SELECTED';
    echo '<option value="25"' . $selected . '>25</option>';
    $selected = '';
    if ($humo_option["smtp_port"] == '465') $selected = ' SELECTED';
    echo '<option value="465"' . $selected . '>465</option>';
    $selected = '';
    if ($humo_option["smtp_port"] == '587') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["smtp_auth"] == 'true') $selected = ' SELECTED';
    echo '<option value="true"' . $selected . '>' . __('true') . '</option>';
    $selected = '';
    if ($humo_option["smtp_auth"] == 'false') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["smtp_encryption"] == 'tls') $selected = ' SELECTED';
    echo '<option value="tls"' . $selected . '>TLS</option>';
    $selected = '';
    if ($humo_option["smtp_encryption"] == 'ssl') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["smtp_debug"] == '0') $selected = ' SELECTED';
    echo '<option value="0"' . $selected . '>' . __('Off') . '</option>';
    $selected = '';
    if ($humo_option["smtp_debug"] == '1') $selected = ' SELECTED';
    echo '<option value="1"' . $selected . '>' . __('Client') . '</option>';
    $selected = '';
    if ($humo_option["smtp_debug"] == '2') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["date_display"] == 'eu') $selected = ' SELECTED';
    echo '<option value="eu"' . $selected . '>' . __('Europe/Global - 5 Jan 1787') . '</option>';
    $selected = '';
    if ($humo_option["date_display"] == 'us') $selected = ' SELECTED';
    echo '<option value="us"' . $selected . '>' . __('USA - Jan 5, 1787') . '</option>';
    $selected = '';
    if ($humo_option["date_display"] == 'ch') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["name_order"] == 'western') $selected = ' SELECTED';
    echo '<option value="western"' . $selected . '>' . __('Western') . '</option>';
    $selected = '';
    if ($humo_option["name_order"] == 'chinese') $selected = ' SELECTED';
    ...
    // timeline default
    echo '<tr id="timeline_anchor"><td>' . __('Default timeline file (per language)') . '</td><td>';
    ...
    $selected = '';
    if ($humo_option["one_name_study"] != 'y') $selected = ' SELECTED';
    echo '<option value="y">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    echo '</select>';
...
if (isset($menu_admin) and $menu_admin == 'settings_homepage') {
    ...
    if ($datasql) {
        ...
        while ($dataDb = $datasql->fetch(PDO::FETCH_OBJ)) {
            ...
            $selected = '';
            if ($lijst[1] == 'center') $selected = ' SELECTED';
            echo '<option value="center"' . $selected . '>' . __('Center') . '</option>';
            $selected = '';
            if ($lijst[1] == 'right') $selected = ' SELECTED';
    ...
    $selected = '';
    if ($humo_option["slideshow_show"] != 'y') $selected = ' SELECTED';
    echo '<option value="y">' . __('Yes') . '</option>';
    echo '<option value="n"' . $selected . '>' . __('No') . '</option>';
    echo '</select>';
    echo '</td></tr>';
