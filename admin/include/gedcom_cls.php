...
class gedcom_cls
{
            ...
            */
            ...
            if ($level[1] == 'CHR') {
                ...
                if ($level[2] == 'ASSO') {
                    if (substr($buffer, 0, 6) === '2 ASSO') {
                        ...
                        // >>>>>>>>>>>>>>>>>>>> TODO change person into CHR? O.a. ivm "3 ROLE WITN" bij CHR en bij BURI
                        //$event['connect_kind'][$event_nr] = 'person';
            ...
            if ($level[1] == 'ASSO') {
                if ($buffer6 === '1 ASSO') {
                    ...
                    // *** Oct. 2024: BE AWARE Aldfaer GEDCOM 5.x is probably wrong. ASSO should be by main person, nog by witness. ***
                    // *** This is changed in Aldfaer GEDCOM 7! ***
                    ...
                    // TODO change person into burial???
                    $event['connect_kind'][$event_nr] = 'person';
    ...
    */
    ...
    function process_association($buffer, $buffer6, $buffer8, $gedcomnumber, $connect_kind = 'person')
    {
        ...
        // TODO change $level[1] into other variable because of civil MARR and religious MARR (same variable)
        ...
        if ($buffer6 === '2 ASSO') {
            ...
            //        $event_connect_id2 = substr($buffer, 8, -1);
            //    }
            //} else {
            //    // 2 WITN Doopgetuige1//
            //    $event_event = substr($buffer, 7);
            //}
        }
