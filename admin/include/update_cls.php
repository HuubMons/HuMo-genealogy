...
class update_cls
{
	...
	function update_v5_2_5()
	{
		...
		$result = $dbh->query($sql);
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update events table";</script>';
		ob_flush();
		flush(); // IE
		...
		$result = $dbh->query($sql);
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update pers table";</script>';
		ob_flush();
		flush(); // IE
		...
		$result = $dbh->query($sql);
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update fam table";</script>';
		ob_flush();
		flush(); // IE
		...
		$result = $dbh->query($sql);
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update address table";</script>';
		ob_flush();
		flush(); // IE
		...
		$result = $dbh->query($sql);
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update connect table";</script>';
		ob_flush();
		flush(); // IE
		...
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update location table";</script>';
		ob_flush();
		flush(); // IE
		...
		$result = $dbh->query($sql);
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update source table";</script>';
		ob_flush();
		flush(); // IE
		...
		$result = $dbh->query($sql);
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update texts table";</script>';
		ob_flush();
		flush(); // IE
		...
		$result = $dbh->query($sql);
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update repo table";</script>';
		ob_flush();
		flush(); // IE
		...
		$result = $dbh->query($sql);
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Update unprocessed table";</script>';
		ob_flush();
		flush(); // IE
		...
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_2_5").innerHTML="Database updated!";</script>';
		ob_flush();
		flush(); // IE
	}
	...
	function update_v5_6_1()
	{
		...
		// *** Show status of database update ***
		echo '<script type="text/javascript">document.getElementById("information v5_6_1").innerHTML="Database updated!";</script>';
		ob_flush();
		flush(); // IE
	}
