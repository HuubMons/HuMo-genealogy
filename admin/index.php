...
/** Save ip address in session to prevent session hijacking due...omg*/
if (isset($_SESSION['current_ip_address']) == false) $_SESSION['current_ip_address'] = $visitor_ip;
...
<head>
    ...
    <link href="/assets/humo/css/admin.css" rel="stylesheet" type="text/css">
