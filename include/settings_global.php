...
$humo_option["version"] = '6.1.3a';  // Version line, DO NOT CHANGE THIS LINE
// >>>> July 2022: also change admin\update\version_check.txt. In use for update through GitHub.
...
$humo_option["version_date"] = '2023-06-22';  // Version date yyyy-mm-dd, DO NOT CHANGE THIS LINE
// >>>> July 2022: also change admin\update\version_check.txt. In use for update through GitHub.
...
if (!isset($humo_option["watermark_text"])) {
    ...
    $sql = "INSERT INTO humo_settings SET setting_variable='watermark_text', setting_value=''";
    @$result = $dbh->query($sql);
}
if (!isset($humo_option["watermark_color_r"])) {
    $humo_option["watermark_color_r"] = '';
    $sql = "INSERT INTO humo_settings SET setting_variable='watermark_color_r', setting_value='224'";
    @$result = $dbh->query($sql);
}
if (!isset($humo_option["watermark_color_g"])) {
    $humo_option["watermark_color_g"] = '';
    $sql = "INSERT INTO humo_settings SET setting_variable='watermark_color_g', setting_value='224'";
    @$result = $dbh->query($sql);
}
if (!isset($humo_option["watermark_color_b"])) {
    $humo_option["watermark_color_b"] = '';
    $sql = "INSERT INTO humo_settings SET setting_variable='watermark_color_b', setting_value='224'";
    @$result = $dbh->query($sql);
}
...
if (!isset($humo_option["min_search_chars"])) {
    ...
    $sql = "INSERT INTO humo_settings SET setting_variable='min_search_chars', setting_value='3'";
    @$result = $dbh->query($sql);
}
if (!isset($humo_option["date_display"])) {
    $humo_option["date_display"] = 'eu';
    $sql = "INSERT INTO humo_settings SET setting_variable='date_display', setting_value='eu'";
    @$result = $dbh->query($sql);
}
if (!isset($humo_option["name_order"])) {
    $humo_option["name_order"] = 'western';
    $sql = "INSERT INTO humo_settings SET setting_variable='name_order', setting_value='western'";
    @$result = $dbh->query($sql);
}
if (!isset($humo_option["default_timeline"])) {
    $humo_option["default_timeline"] = '';
    $sql = "INSERT INTO humo_settings SET setting_variable='default_timeline', setting_value=''";
    @$result = $dbh->query($sql);
}
// one name study display
if (!isset($humo_option["one_name_study"])) {
    $humo_option["one_name_study"] = 'n';
    $sql = "INSERT INTO humo_settings SET setting_variable='one_name_study', setting_value='n'";
    @$result = $dbh->query($sql);
}
