...
use Genealogy\Include\EditorEventSelection;
...
class EditorEvent
{
    ...
    // TODO create class, also used for include/witness.php.
    ...
    function event_text($event_kind, $event_gedcom = '', $event_event_extra = '')
    {
        if ($event_kind == 'picture') {
            ...
            if ($event_text == 'informant') {
                $event_text = __('informant');
            }
            if ($event_text == 'funeral leader') {
                $event_text = __('funeral leader');
            }
...
?>
    ...
    function show_event($event_connect_kind, $event_connect_id, $event_kind)
    {
        ...
        $editorEventSelection = new EditorEventSelection();
        ...
        // *** Remark: not all queries needs event_place (from location table) ***
                                                ...
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        if ($data_listDb->event_kind == 'name') {
                                                            ...
                                                            $editorEventSelection->event_selection($data_listDb->event_gedcom);
                                                            echo '</select>';
                                                        }
