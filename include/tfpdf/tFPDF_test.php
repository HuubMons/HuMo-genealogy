...
class tFPDF
{
    ...
    function SetTitle($title, $isUTF8 = false)
    {
        ...
        $this->metadata['Title'] = $isUTF8 ? $title : mb_convert_encoding($title, 'UTF-8', 'ISO-8859-2');
    }
    ...
    function SetAuthor($author, $isUTF8 = false)
    {
        ...
        $this->metadata['Author'] = $isUTF8 ? $author : mb_convert_encoding($author, 'UTF-8', 'ISO-8859-2');
    }
    ...
    function SetSubject($subject, $isUTF8 = false)
    {
        ...
        $this->metadata['Subject'] = $isUTF8 ? $subject : mb_convert_encoding($subject, 'UTF-8', 'ISO-8859-2');
    }
    ...
    function SetKeywords($keywords, $isUTF8 = false)
    {
        ...
        $this->metadata['Keywords'] = $isUTF8 ? $keywords : mb_convert_encoding($keywords, 'UTF-8', 'ISO-8859-2');
    }
    ...
    function SetCreator($creator, $isUTF8 = false)
    {
        ...
        $this->metadata['Creator'] = $isUTF8 ? $creator : mb_convert_encoding($creator, 'UTF-8', 'ISO-8859-2');
    }
