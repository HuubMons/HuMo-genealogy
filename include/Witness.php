        ...
        if ($gedcomnr) {
            ...
            foreach ($witness_qry as $witnessDb) {
                ...
                if ($event_connect_kind == 'person') {
                    $source_array = $showSources->show_sources2($event_connect_kind, "pers_event_source", $witnessDb->event_id);
                } else {
                    $source_array = $showSources->show_sources2($event_connect_kind, "fam_event_source", $witnessDb->event_id);
                }
                if ($source_array) {
