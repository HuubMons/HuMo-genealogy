...
class OutlineReportModel extends FamilyModel
{
    ...
    {
        $show_details = false;
        if (isset($_GET["show_details"]) and (is_numeric(($_GET["show_details"])))) {
            $show_details = $_GET["show_details"];
        }
        if (isset($_POST["show_details"]) and (is_numeric($_POST["show_details"]))) {
    ...
    {
        $show_date = true;
        if (isset($_GET["show_date"]) and (is_numeric($_GET["show_date"]))) {
            $show_date = $_GET["show_date"];
        }
        if (isset($_POST["show_date"]) and (is_numeric($_POST["show_date"]))) {
    ...
    public function getDatesBehindNames()
    {
        ...
        if (isset($_GET["dates_behind_names"]) and (is_numeric($_GET["dates_behind_names"]))) {
            $dates_behind_names = $_GET["dates_behind_names"];
        }
        if (isset($_POST["dates_behind_names"]) and (is_numeric($_POST["dates_behind_names"]))) {
    ...
    public function getNrGenerations($humo_option)
    {
        ...
        if (isset($_GET["nr_generations"]) and is_numeric($_GET["nr_generations"])) {
            $nr_generations = $_GET["nr_generations"];
        }
        if (isset($_POST["nr_generations"]) and is_numeric($_POST["nr_generations"])) {
