...
<div class="help_div">
	<div class="help_box">
		...
		<span class="help_explanation"><img src="<?= CMS_ROOTPATH; ?>images/ancestor_report.gif" alt="Pedigree">&nbsp;<b><?= __('Ancestor report'); ?></b>
		...
		<span class="help_explanation"><img src="<?= CMS_ROOTPATH; ?>images/outline.gif" alt="Outline report">&nbsp;<b><?= __('Outline report'); ?></b>
		...
		<span class="help_explanation"><img src="<?= CMS_ROOTPATH; ?>images/ancestor_chart.gif" alt="ancestor sheet">&nbsp;<b><?= __('Ancestor sheet'); ?></b>
		...
		<span class="help_explanation"><img src="<?= CMS_ROOTPATH; ?>images/fanchart.gif" alt="Fanchart">&nbsp;<b><?= __('Fanchart'); ?></b>
