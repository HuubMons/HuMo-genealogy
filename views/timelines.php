    ...
    for ($i = 0; $i < count($marriages); $i++) {
        ...
        if (!$privacy) {
            if (isset($spouse2Db->pers_death_date) and $spouse2Db->pers_death_date) {
                ...
                if ($temp and $temp > 0 and $temp < 2200) {
                    if ($spouse2Db->pers_sexe == "M") {
                        $spouse = __('SPOUSE_MALE');
                    } else {
                        $spouse = __('SPOUSE_FEMALE');
                    }
                    ...
                    if ($age) {
                        $spousedeathtext[$i] = '[' . $age . '] ' . $spousedeathtext[$i];
                    }
                }
            }
        ...
        if ($familyDb->fam_children) {
            ...
            for ($m = 0; $m < count($children[$i]); $m++) {
                ...
                if (
                    $user["group_pers_hide_totally_act"] == 'j' and isset($chldDb->pers_own_code)
                ...
                if (!$privacy) {
                    ...
                    if ($temp > 0 and $temp < 2200) {
                        ...
                        if ($age) {
                            $chborntext[$i][$m] = '[' . $age . '] ' . $chborntext[$i][$m];
                        }
                    }
                    ...
                    if ($temp > 0 and $temp < 2200) {
                        ...
                        if ($age) {
                            $chdeathtext[$i][$m] = '[' . $age . '] ' . $chdeathtext[$i][$m];
                        }
                    }
                } else {
                    // *** Privacy filter activated ***
                    ...
                    for ($p = 0; $p < count($chmarriages[$i][$m]); $p++) {
                        ...
                        if (!$privacy) {
                            ...
                            if ($temp and $temp > 0 and $temp < 2200) {
                                ...
                                if ($age) {
                                    $chmarrtext[$i][$m][$p] = '[' . $age . '] ' . $chmarrtext[$i][$m][$p];
                                }
                            }
                        } else {
                            // *** Privacy filter activated ***
                        ...
                        if ($chfamilyDb->fam_children) {
                            ...
                            for ($g = 0; $g < count($grchildren[$i][$m][$p]); $g++) {
                                ...
                                if (!$privacy) {
                                    ...
                                    $grchbornyear[$i][$m][$p][$g] = '';
                                    $grchborndate[$i][$m][$p][$g] = '';
                                    $grchborntext[$i][$m][$p][$g] = '';
                                    $grchdeathyear[$i][$m][$p][$g] = '';
                                    $grchdeathdate[$i][$m][$p][$g] = '';
                                    $grchdeathtext[$i][$m][$p][$g] = '';
                                    $temp = '';

                                    if ($grchldDb->pers_sexe == "M") {
                                        $grchild = __('grandson');
                                    } else if ($grchldDb->pers_sexe == "F") {
...
elseif (isset($humo_option['default_timeline']) and $humo_option['default_timeline'] != "") {
    ...
    //if(!isset($val_arr[$selected_language]) AND is_file("languages/default_timelines/".$val_arr[$selected_language2].".txt")) {
    ...
    <tr>
        <td>
            <form name="tmlstep" method="post" action="<?= $path; ?>" style="display:inline;">
                ...
                echo 'onmouseover="mopen(event,\'help_menu\',10,150)" onmouseout="mclosetime()">';
