...
$maxgens = 7;
$fan_width = "auto";
$top_for_name = 20; // Text on Top: Name of base person and print-help link 
...
if (!isset($_POST['show_desc'])) {
	if (isset($_SESSION['save_show_desc'])) {
...
$db_functions->check_person($person_id); // Check if person gedcomnumber is valid
...
{
	global $db_functions, $maxperson;
	global $treeid, $indexnr;
	if ($nr >= $maxperson) {
		return;
	}
	if ($famid) {
