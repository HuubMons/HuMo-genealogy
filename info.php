...
<div style="direction:ltr;margin-left:10px">
	...
	<p>
		<?= sprintf(__('%s is a free, open-source and multilingual server-side program that makes it very easy to publish your genealogical data on the internet as a dynamic and searchable family tree website.'), 'HuMo-genealogy'); ?>
	</p>
	<p>
		<?= sprintf(__('There are 2 official %s websites:'), 'HuMo-genealogy'); ?>
		<br>
