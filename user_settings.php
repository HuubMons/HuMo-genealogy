...
?>
    ...
    <br>
    <form id="form_id" method="post" action="<?= $action; ?>" accept-charset="utf-8">

        <table align="center" class="humo small" style="width:80%;">
            <tr class=table_headline>
                <th class="fonts" colspan="2"><?= __('User settings'); ?></th>
            </tr>
            ...
            ?>
                <tr>
                    <td><?= __('Password'); ?></td>
                    <td><input type="password" class="fonts" name="register_password" size="30" style="background-color:#FFFFFF" value="<?= $register_password; ?>"></td>
                </tr>

                <tr>
                    <td><?= __('Repeat password'); ?></td>
                    <td><input type="password" class="fonts" name="register_repeat_password" size="30" style="background-color:#FFFFFF" value="<?= $register_repeat_password; ?>"></td>
                </tr>

                <!-- *** Use HTML5 e-mail check *** -->
                <tr>
                    <td><?= __('E-mail address'); ?></td>
                    <td><input type="email" class="fonts" id="register_mail" name="register_mail" value="<?= $register_mail; ?>" size="30" style="background-color:#FFFFFF"> </td>
                </tr>
                <?php
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= $action; ?>?2fa=1"><?= __('Two factor authentication (2FA)'); ?></a>
                        </td>
                    </tr>
                    <?php
                    ...
                    ?>
                        <tr>
                            <td>
                                ...
                                <?= __('More information about 2FA can be found at internet.'); ?>
                            </td>
                            <td>
...
?>
    ...
    <table class="humo">
        <tr class=table_headline>
            <th class="fonts"><?= __('Select a theme'); ?></th>
        </tr>
        <td align="center">
            <form title="<?= __('Select a colour theme (a cookie will be used to remember the theme)'); ?>" action="">
