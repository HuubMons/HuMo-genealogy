...
// *** For index places ***
$place_name = '';
$select_marriage_notice = '0';
$select_marriage = '0';
$select_place = '0';
$select_marriage_notice_religious = '0';
$select_marriage_religious = '0';
if (isset($_POST['place_name'])) {
    ...
    if (isset($_POST['select_marriage_notice_religious'])) {
        $select_marriage_notice_religious = '1';
...
if (isset($_GET['reset'])) {
    ...
    if (isset($_SESSION["save_select_marriage_notice"])) {
        $select_marriage_notice = $_SESSION["save_select_marriage_notice"];
    }
    if (isset($_SESSION["save_select_marriage"])) {
        $select_marriage = $_SESSION["save_select_marriage"];
    }
    if (isset($_SESSION["save_select_marriage_notice_religious"])) {
        $select_marriage_notice_religious = $_SESSION["save_select_marriage_notice_religious"];
    }
    if (isset($_SESSION["save_select_marriage_religious"])) {
        $select_marriage_religious = $_SESSION["save_select_marriage_religious"];
    }
}
