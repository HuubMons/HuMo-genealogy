...
if (isset($_POST["screen_mode"]) and $_POST["screen_mode"] == 'ASPDF') {
	$screen_mode = 'ASPDF';
}
if (isset($_GET["screen_mode"]) and $_GET["screen_mode"] == 'ancestor_sheet') {
	$screen_mode = 'ancestor_sheet';
}
if (isset($_GET["screen_mode"]) and $_GET["screen_mode"] == 'ancestor_chart') {
