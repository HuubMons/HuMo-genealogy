...
__  
The automatic update needs to download new HuMo-genealogy files and unzip them. Unfortunately some providers don’t allow these options due to safety reasons._
...
_S__ometimes a database update will be done, it's possibl__e_ _the old version doesn't work anymore!_
...
1) If you want, create a backup of the file: db_login.php
